...
const plugins_easy = [
  'autoresize directionality advlist autolink autosave colorpicker contextmenu directionality fullscreen insertdatetime lists powerpaste print save searchreplace spellchecker tabfocus  textcolor textpattern visualblocks visualchars wordcount code'
]
export {
  plugins_default,
  plugins_easy
